 ...
 * @notice This library is used to check the Chainlik Oracle for stale data
 * If a price is stale, functions will revert and render DSCEngine unusable
...
library Oracle {
     ...
     * to block.timestamp
     */
    // function consult(IPoolManager pool, uint32 secondsAgo)
    //     internal
    //     view
    ...
    //     (int56[] memory tickCumulatives, uint160[] memory secondsPerLiquidityCumulativeX128s) = observe(
    //         Struct.Observation[65535], // self
    //         uint32(block.timestamp),
    //         secondsAgos,
    //         pool.slot0().tick,
    //         pool.slot0().observationIndex,
    //         pool.liquidity(),
    //         pool.slot0().observationCardinality
    //     );
     ...
     */
    // function getMaxSecondsAgo(IPoolManager pool, uint16 observationIndex, uint16 observationCardinality)
    //     internal
    //     view
