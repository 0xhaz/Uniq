...
//         assertEq(fee, 0);
//         assertEq(swapDelta.amount0(), -1094882882536075235);
...
//         assertEq(uniqHook.volatility(), highVolatility);
...
//     function testUniqHook1to1_BuyInRisingMarket_IncreaseFee() public {
//         uint256 balance1Before = poolKey.currency1.balanceOfSelf();
//         int256 amountSpecified = 1 ether;
//         uint248 volatility = 200;
...
//         uint24 fee = uniqHook.getFee(amountSpecified);
//         console.log("Buy in rising market fee: %d", fee);
...
//     function testUniqHook1to1_SellingInFallingMarket_DecreaseFee() public {
//         uint256 balance1Before = poolKey.currency1.balanceOfSelf();
//         int256 amountSpecified = -1 ether;
//         uint248 volatility = 200;
...
//         // assert(fee < 200);
//         assertEq(swapDelta.amount0(), -1000000000000000000);
//         uint256 token1Output = currency1.balanceOfSelf() - balance1Before;
//         console.log("token1Output: %d", token1Output);
//         assertEq(int256(swapDelta.amount1()), int256(token1Output));
//         assertEq(int256(token1Output), amountSpecified);
//     }
